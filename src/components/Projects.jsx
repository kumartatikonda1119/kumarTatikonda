...
function Projects() {
  const projects = [
    ...
    },
    {
      ...
      desc: "Analyze and visualize movie reviews using sentiment analysis and charts.",
      img: movie,
      tech: ["Python", "Pandas", "NLP", "Scikit-Learn"],
      live: "https://sentimentalanalysisfrommoviereview.streamlit.app/",
      code: "https://github.com/kumartatikonda1119/MovieReviewAnalysis",
    },
    {
      id: 7,
      title: "FinMate",
